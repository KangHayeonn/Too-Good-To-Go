...
=== SHOP 업데이트 [POST]
operation::shops/update[snippets='http-request,request-headers,http-response,response-fields']

=== SHOP 삭제 [DELETE]
operation::shops/delete[snippets='http-request,request-headers,http-response']
...
=== PRODUCT 조회 [GET]
operation::products/find[snippets='http-request,http-response,response-fields']

=== PRODUCT 추가 [POST]
operation::products/add[snippets='http-request,request-headers,http-response,response-fields']

=== PRODUCT 업데이트 [POST]
operation::products/update[snippets='http-request,request-headers,http-response,response-fields']

=== PRODUCT 우선순위 업데이트 [PATCH]
operation::products/updatePriority[snippets='http-request,request-headers,http-response,response-fields']

=== PRODUCT 삭제 [DELETE]
operation::products/delete[snippets='http-request,request-headers,http-response']
...
=== PRODUCT 카테고리 조회 [GET]
operation::products/category[snippets='http-request,http-response,response-fields']

=== PRODUCT Shop 별 우선순위 조회 [GET]
operation::products/shop[snippets='http-request,http-response,response-fields']
