...
class ShopsControllerTest {
    ...
    public void setUp() {
        ...
        shopRepository.save(Shop.builder().name("shop1").image("test1").category(new String[]{"한식"}).build());
        shopRepository.save(Shop.builder().name("shop2").image("test2").category(new String[]{"중식"}).build());
    }
